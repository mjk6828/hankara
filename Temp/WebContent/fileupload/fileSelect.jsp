...
<body topmargin="100">
	<div align="center">
		<font color="#0000FF" size="2">
			복수개의 파일 업로드를 위하여 파일 개수를 입력한 수<br>
			확인 버튼을 눌러 주세요!!<br>
	...
	<form action="" name="frmName1" method="post">
		...
		cellpadding="1" cellspacing="1" bordercolor="#660000" bgcolor="#FFFF99">
			...
			<tr bgcolor="#FFCC00">
				...
				<td width="50%" colspan="3">
					<textarea cols="40" name="abstract"
